"""
Tabla de codigos CIIU (Clasificacion Industrial Internacional Uniforme),
adaptada para Colombia por el DANE y adoptada por la DIAN (Resolucion 66 de
2012) para el campo "Actividad economica" del RUT.

Fuente: https://github.com/Startup-Colombia/CIIU (CIIU.json, dominio publico),
aplanada de su estructura seccion/division/subdivision a un diccionario simple
codigo de 4 digitos -> descripcion. Verificada contra un RUT real: el codigo
4663 coincide exactamente con la descripcion que trae el propio documento de
la DIAN.
"""

CODIGOS_CIIU: dict[str, str] = {
    "0010": "Asalariados",
...
def descripcion_ciiu(codigo: str | None) -> str | None:
    if not codigo:
        return None
    return CODIGOS_CIIU.get(codigo.strip())
